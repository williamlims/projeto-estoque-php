...
<head>
	...
	<title>Itens | Controle de Estoque</title>
	...
	<div class="container-fluid">
		<div class="row flex-nowrap">
				...
				<div id="sidebar" class="collapse collapse-horizontal show border-end">
					<div class="d-flex flex-column vh-100 flex-shrink-0 p-3 text-white bg-dark" style="width: 250px;">
						<ul class="nav nav-pills flex-column mb-auto">
							...
							<li><a href="itens.php" class="nav-link text-white active"><i class="fa fa-list-alt" aria-hidden="true"></i> Itens</a></li>
			...
			<main class="col ps-md-2 pt-2">
				<div class="row">
					<span class="p-1 w-100 mx-2 px-3 py-2 bg-light bg-gradient text-muted">Home / Itens</span>
